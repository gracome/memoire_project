            ...
            <div class="appbar-wrapper hide-scrollbar">
                ...
                <ul class="nav nav-minimal appbar-nav" id="appNavTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="translator-tab" data-toggle="tab" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#translator" role="tab" aria-controls="translator" aria-selected="true">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="notes-tab" data-toggle="tab" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#notes" role="tab" aria-controls="notes" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="todo-tab" data-toggle="tab" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#todo" role="tab" aria-controls="todo" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="quick-settings-tab" data-toggle="tab" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#quick-settings" role="tab" aria-controls="quick-settings" aria-selected="false">
                        ...
                        <div class="d-flex flex-column justify-content-center text-center h-100 w-100">
                            <div class="container">
                                <div class="avatar avatar-lg mb-2">
                                    <!-- <img class="avatar-img" src="./light-skin_files/4.png" alt=""> -->
                                </div>
                                ...
                                <div class="appnavbar-body-title">
                                    <div class="dropdown w-100">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">English</a>
                                            <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Hindi</a>
                                            <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Irish</a>
                                            <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Latin</a>
                                            <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Russian</a>
                                        </div>
                                        <!-- Dropdown Menu End -->
                                    </div>
                            
                                    <!-- <img class="injetable hw-16 text-muted mx-1" src="./light-skin_files/arrow-right.svg" alt=""> -->
                            ...
                            <div class="appnavbar-body">
                                <div class="appnavbar-body-title">
                                    ...
                                    <div class="dropdown mr-2">
                                        ...
                                        <!-- Dropdown Menu Start -->
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" data-notes-filter="" data-select="all-chats" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">All Notes</a>
                                            <a class="dropdown-item" data-notes-filter="" data-select="friends" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Personal</a>
                                            <a class="dropdown-item" data-notes-filter="" data-select="groups" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Work</a>
                                            <a class="dropdown-item" data-notes-filter="" data-select="unread" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Favourite</a>
                                            <a class="dropdown-item" data-notes-filter="" data-select="archived" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Important</a>
                                        </div>
                                        <!-- Dropdown Menu End -->
                                    </div>
                                            ...
                                            <div class="note-tools">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Personal</a>
                                                        <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Work</a>
                                                        <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Favourite</a>
                                                        <a class="dropdown-item" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Important</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item text-danger" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="appnavbar-body">
                                <div class="appnavbar-body-title">
                                    ...
                                    <div class="dropdown mr-2">
                                        ...
                                        <!-- Dropdown Menu Start -->
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" data-task-filter="" data-select="all-tasks" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">All Tasks</a>
                                            <a class="dropdown-item" data-task-filter="" data-select="active" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Active</a>
                                            <a class="dropdown-item" data-task-filter="" data-select="finished" href="http://prismthemes.com/quicky/ltr/light-skin/index.html#">Finished</a>
                                        </div>
                                        <!-- Dropdown Menu End -->
                                    </div>
                                    <!-- Sidebar Header Dropdown End -->
